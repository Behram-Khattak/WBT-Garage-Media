          ...
          >
            ...
            <div>
              ...
              <div className="flex gap-8">
                <a href="https://www.instagram.com/wbt_garage/" className="text-2xl text-foreground/70 hover:text-accent transition-colors transform hover:-translate-y-1 duration-300">
                  <SiInstagram />
                </a>
                <a href="https://www.youtube.com/@WBT_garage" className="text-2xl text-foreground/70 hover:text-accent transition-colors transform hover:-translate-y-1 duration-300">
                  <SiYoutube />
                </a>
              </div>
            </div>
